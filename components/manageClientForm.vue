...
<template>
	<v-container class="sc-pa-8 sc-rounded-xl" max-width="600px">
		<div class="sc-flex sc-align-center sc-mb-6">
			...
			<div class="ml-4">
				<h2 class="text-h6 font-weight-bold">Nuevo Cliente</h2>
				<v-btn text color="primary">Cargar Foto</v-btn>
			</div>
		</div>

		<v-form class="sc-flex sc-flex-col sc-gap-5" @submit.prevent="handleSubmit">
			<v-text-field v-model="formData.displayName" label="Change Display Name" hide-details="auto"></v-text-field>

			<v-text-field v-model="formData.businessEmail" label="Business Email" hide-details="auto"></v-text-field>

			<v-text-field v-model="formData.contactNumber" label="Contact Number" hide-details="auto"></v-text-field>
			...
			<v-text-field v-model="formData.emergencyContact" label="Emergency Contact" hide-details="auto"></v-text-field>
